...
public class GameProcessForm extends KeyListenerForm {
    ...
    public GameProcessForm(ModelFacade model, Form stepForm) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
        ...
        gameStep.add(stepForm.getRootComponent());
    }
    ...
    private void $$$setupUI$$$() {
        ...
        gameStep = new JPanel();
        gameStep.setLayout(new BorderLayout(0, 0));
        panel.add(gameStep, BorderLayout.CENTER);
        gameStep.setBorder(BorderFactory.createTitledBorder(BorderFactory.createRaisedBevelBorder(), "World map", TitledBorder.CENTER, TitledBorder.BELOW_TOP, this.$$$getFont$$$("Phosphate", -1, 24, gameStep.getFont())));
    }
